...
// import static com.spartronics4915.frc2024.Constants.AutoAimConstants.kGravity;
// import static com.spartronics4915.frc2024.Constants.AutoAimConstants.kShooterHeight;
// import static com.spartronics4915.frc2024.Constants.AutoAimConstants.kShooterSpeed;
...
public class AutoAimFunctions {
    ...
    public static Optional<Translation3d> movingAutoAim(
        ...
        double px = p.getX();
        double py = p.getY();
        double kShooterHeight;
        double pz = targetPos.getZ() -2.5;// kShooterHeight;
        ...
        double ay = 0;
        int kGravity;
        double az = 0 - 3;//kGravity; // relative to the robot the speaker will be accelerating upwards

        double kShooterSpeed;
        double s =3000;// kShooterSpeed;
